...
export const reportDate = "2026-05-14";
...
export const competitors: Competitor[] = [
  {
    ...
    maturity: "早期产品",
    pricingModel: "订阅",
    pricing: "Mobilerun 已公开按手机资源收费：Personal Phone $4/月，Cloud Phone $40/月，Physical Phone $120/月，均按年计费；另含 AI Agent credits。",
    pricingDetails: { type: "设备订阅 + AI Agent Credits", price: "Personal Phone $4/月；Cloud Phone $40/月；Physical Phone $120/月", note: "用户不是只买开源框架，而是在买可被 AI 调用的手机资源。Personal 是自带手机接入，Cloud 是虚拟云手机，Physical 是专属真实设备；额度分别约 250 / 2,500 / 5,000 credits/月。" },
    ...
    weaknesses: ["商业模式已经转向设备订阅，规模化跑真机会形成持续成本", "产品仍偏开发者工具", "普通运营人员需要的模板和报表还不够"],
    ...
    sources: [{ label: "官网/定价", url: "https://mobilerun.ai/pricing" }, { label: "官方文档", url: "https://docs.mobilerun.ai/framework/overview" }, { label: "官方 GitHub", url: "https://github.com/droidrun/mobilerun" }],
  ...
  },
  {
    ...
    maturity: "商业化",
    pricingModel: "订阅",
    pricing: "随 ChatGPT 账号套餐提供。用户为 ChatGPT 席位付费，Agent 是套餐权益之一；Plus/Pro/Business/Enterprise 的可用额度和开放范围不同。",
    pricingDetails: { type: "账号订阅权益", price: "Plus 约 $20/月；Pro 约 $200/月；Business/Enterprise 按席位或合同计费", note: "买的是 ChatGPT 通用 Agent 能力和消息额度，不是独立购买浏览器机器人，也不是手机真机资源；高风险动作仍需要确认。" },
    ...
    sources: [{ label: "ChatGPT agent 官方发布", url: "https://openai.com/index/introducing-chatgpt-agent/" }, { label: "官方帮助中心", url: "https://help.openai.com/en/articles/11752874-chatgpt-agent" }, { label: "ChatGPT 定价", url: "https://openai.com/chatgpt/pricing/" }],
    lastChecked: reportDate
  },
  {
    ...
    maturity: "商业化",
    pricingModel: "按量",
    pricing: "按 Claude API 模型 token 计费。Computer Use 本身是开发者能力，不是单独 SaaS 套餐；截图、长上下文和多轮工具调用会放大 token 成本。",
    pricingDetails: { type: "API 按量计费", price: "按所选 Claude 模型 input/output token 计费；Sonnet 常见为 $3/$15 每百万 input/output tokens", note: "用户付的是模型调用费和自建执行环境成本；Computer Use 多轮截图和工具调用会持续消耗 token，Anthropic 不替你提供完整桌面/浏览器托管产品。" },
    ...
    sources: [{ label: "官方文档", url: "https://docs.anthropic.com/en/docs/build-with-claude/computer-use" }, { label: "API 定价", url: "https://www.anthropic.com/pricing#api" }],
    lastChecked: reportDate
  },
  {
    ...
    maturity: "商业化",
    pricingModel: "按量",
    pricing: "Browser Use Cloud 是平台订阅 + 用量额度：Free / Pro / Team / Scale 分层，公开页显示 Pro $20/月、Team $30/月/人、Scale $100/月/人。",
    pricingDetails: { type: "平台订阅 + 浏览器任务额度", price: "Free；Pro $20/月；Team $30/月/人；Scale $100/月/人", note: "用户为云浏览器、任务运行、团队协作和执行额度付费；不是手机 App 控制，复杂任务会消耗更多步骤/额度。" },
  ...
  },
  {
    ...
    maturity: "商业化",
    pricingModel: "订阅",
    pricing: "Skyvern 采用订阅 + credits。Free 给少量 credits；Hobby/Pro 提升 credits 和并发/团队能力；Enterprise 走定制合同。",
    pricingDetails: { type: "浏览器工作流订阅 + Credits", price: "Free 1,000 credits；Hobby $29/月；Pro $149/月；Enterprise custom", note: "用户为网页任务执行额度、团队能力和企业治理付费；企业版通常包含自托管、SLA、安全和更高并发。" },
  ...
  },
  {
    ...
    maturity: "商业化",
    pricingModel: "订阅",
    pricing: "Manus 是会员订阅 + credits。Free $0/月含每日刷新 credits；Pro 从 $20/月或 $40/月起，Team 从 $20/席位/月起。",
    pricingDetails: { type: "会员订阅 + Credits", price: "Free $0/月；Pro $20/月起含 4,000 credits；Pro $40/月起含 8,000 credits；Team $20/席位/月起", note: "用户买的是云端 Agent 任务额度、并发任务、定时任务和团队管理能力；官方说明最终以账号实际 pricing 页面为准。" },
  ...
  },
  {
    ...
    maturity: "早期产品",
    pricingModel: "开源/免费",
    pricing: "官网口径为软件免费使用，商业成本主要转移到用户自带模型 API、浏览器环境、账号和本地运行维护。",
    pricingDetails: { type: "免费软件 + 自带模型/API 成本", price: "软件免费；模型 API、账号和本地机器成本自理", note: "它更像免费客户端拉用户，付费点不在软件本身；合规、安全和模型账单由用户承担。" },
  ...
  },
  {
    ...
    maturity: "成熟企业",
    pricingModel: "企业定制",
    pricing: "UiPath 是企业平台订阅。公开页提供 Basic 起价，Standard/Enterprise 通常按机器人、Agent、平台模块和治理能力打包报价。",
    pricingDetails: { type: "企业平台订阅 + 机器人/Agent 授权", price: "Basic 起价 $25/月；Standard / Enterprise 联系销售", note: "用户为自动化平台、机器人数量、Agentic Automation、文档处理、治理、安全和企业部署范围付费。" },
...
export const traditionalAutomationCompetitors: Competitor[] = [
  {
    ...
    maturity: "成熟企业",
    pricingModel: "一次性购买",
    pricing: "Tasker 是 Android 付费 App，一次性买断下载；不同国家/商店显示价格不同，常见在 $3-$5 区间。",
    pricingDetails: { type: "一次性 App 买断", price: "Google Play 一次性付费，常见约 $3-$5", note: "用户买的是本地自动化工具和插件生态入口；没有云端执行额度，也没有 AI 任务托管。" },
  ...
  },
  {
    ...
    maturity: "商业化",
    pricingModel: "一次性购买",
    pricing: "Automate 是免费安装 + Premium 解锁。免费版适合轻量流程，高级/大规模流程通常需要通过 Google Play 内购解锁 Premium。",
    pricingDetails: { type: "免费安装 + Premium 一次性解锁", price: "基础免费；Premium 价格以 Google Play 当地商店为准", note: "用户为流程图自动化能力和更多 blocks/高级使用付费；没有 AI credits，也没有云端手机资源。" },
  ...
  },
  {
    ...
    maturity: "商业化",
    pricingModel: "企业定制",
    pricing: "Maestro 核心 CLI/框架开源免费；商业化主要来自 Maestro Cloud、团队协作、CI 执行、测试报告和企业支持，具体价格以官方销售/账号页为准。",
    pricingDetails: { type: "开源框架 + 测试云/团队服务", price: "本地框架免费；云端/团队/企业能力按官方报价", note: "用户为移动/Web UI 自动化测试基础设施付费，不是为 AI 自主 Agent 付费。" },
    ...
    sources: [{ label: "官网", url: "https://maestro.dev/" }, { label: "Maestro Cloud", url: "https://maestro.dev/cloud" }, { label: "官方 GitHub", url: "https://github.com/mobile-dev-inc/Maestro" }],
    lastChecked: reportDate
  },
  {
  ...
  },
  {
    ...
    maturity: "成熟企业",
    pricingModel: "订阅",
    pricing: "AnyDesk 是远控账号订阅，按 Solo / Standard / Advanced / Ultimate 分层；核心变量是用户数、并发连接、托管设备数、移动设备支持和企业安全能力。",
    pricingDetails: { type: "远控账号/设备订阅", price: "Solo / Standard / Advanced / Ultimate 分层，官网结算页按地区显示价格", note: "用户为远程连接、无人值守访问、托管设备、移动支持和企业管理能力付费，不是为 AI 自动执行结果付费。" },
  ...
  },
  {
    ...
    maturity: "成熟企业",
    pricingModel: "订阅",
    pricing: "TeamViewer 是远程支持/设备管理订阅，按个人、团队和企业授权分层；移动设备支持、资产管理、DEX、AI 会话摘要等会进入更高阶套餐或附加模块。",
    pricingDetails: { type: "远程支持授权 + 企业模块", price: "Remote Access / Business / Premium / Corporate / Enterprise 等分层，价格按地区官网结算页显示", note: "用户为远程连接席位、并发会话、托管设备、移动支持和企业 IT 模块付费。" },
  ...
  },
  {
    ...
    maturity: "成熟企业",
    pricingModel: "订阅",
    pricing: "Power Automate 按用户和 bot/流程能力收费：Premium $15/用户/月，Process $150/bot/月，Hosted Process $215/bot/月，通常按年计费。",
    pricingDetails: { type: "用户席位 + Bot/流程订阅", price: "Premium $15/用户/月；Process $150/bot/月；Hosted Process $215/bot/月", note: "用户为低代码流程、桌面 RPA、云流程连接器和无人值守 bot 付费；成本随用户数、bot 数和托管执行需求增长。" },
